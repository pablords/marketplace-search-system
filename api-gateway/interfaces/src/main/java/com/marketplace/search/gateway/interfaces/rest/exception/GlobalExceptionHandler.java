package com.marketplace.search.gateway.interfaces.rest.exception;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(CatalogServicePort.CatalogServiceException.class)
    public ResponseEntity<ErrorResponse> handleCatalogServiceException(
            CatalogServicePort.CatalogServiceException ex, WebRequest request) {
        ...
        logger.error("Erro ao comunicar com catalog-service: {}", ex.getMessage(), ex);

        return ResponseEntity.status(HttpStatus.BAD_GATEWAY).body(errorResponse);
    }

    @ExceptionHandler(SearchServicePort.SearchServiceException.class)
    public ResponseEntity<ErrorResponse> handleSearchServiceException(
            SearchServicePort.SearchServiceException ex, WebRequest request) {
        ...
        logger.error("Erro ao comunicar com search-service: {}", ex.getMessage(), ex);
