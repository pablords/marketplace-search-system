...
public class ProductMapper {
    ...
    private Seller mapSeller(SellerDTO dto) {
        SellerReputation reputation = dto.getReputation() != null ?
            mapSellerReputation(dto.getReputation()) :
    ...
    private com.marketplace.search.domain.valueobjects.SellerType mapSellerType(String type) {
        if (type == null) return com.marketplace.search.domain.valueobjects.SellerType.REGULAR;
    ...
    private com.marketplace.search.domain.valueobjects.SellerStatus mapSellerStatus(String status) {
        if (status == null) return com.marketplace.search.domain.valueobjects.SellerStatus.ACTIVE;
