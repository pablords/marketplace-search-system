...
public class ProductDocument {
    ...
    public CategoryDocument getCategory() { return category; }
    public void setCategory(CategoryDocument category) { this.category = category; }

    public BrandDocument getBrand() { return brand; }
    public void setBrand(BrandDocument brand) { this.brand = brand; }

    public SellerDocument getSeller() { return seller; }
    public void setSeller(SellerDocument seller) { this.seller = seller; }
    ...
    public ProductMetricsDocument getMetrics() { return metrics; }
    public void setMetrics(ProductMetricsDocument metrics) { this.metrics = metrics; }

    public ProductStatusDocument getStatus() { return status; }
    public void setStatus(ProductStatusDocument status) { this.status = status; }
