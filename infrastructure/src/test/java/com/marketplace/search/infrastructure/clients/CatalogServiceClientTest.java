...
class CatalogServiceClientTest {
    ...
    void shouldUpdateProductSuccessfully() {
        ...
        // Act & Assert
        StepVerifier.create(catalogServiceClient.updateProduct(productId, productDTO))
                .verifyComplete();
    }
    ...
    void shouldThrowExceptionWhenUpdatingNonExistentProduct() {
        ...
        when(requestBodySpec.bodyValue(any())).thenReturn(requestHeadersSpec);
        when(requestHeadersSpec.retrieve()).thenReturn(responseSpec);
        when(responseSpec.toBodilessEntity()).thenReturn(Mono.error(notFoundError));
    ...
    void shouldDeleteProductSuccessfully() {
        ...
        // Act & Assert
        StepVerifier.create(catalogServiceClient.deleteProduct(productId))
                .verifyComplete();
    }
    ...
    void shouldGetProductSuccessfully() {
        ...
        // Act & Assert
        StepVerifier.create(catalogServiceClient.getProduct(productId))
    ...
    void shouldThrowExceptionWhenProductNotFound() {
        ...
        when(requestHeadersUriSpec.uri(anyString(), anyString())).thenReturn(requestHeadersSpec);
        when(requestHeadersSpec.retrieve()).thenReturn(responseSpec);
        when(responseSpec.bodyToMono(ProductDTO.class)).thenReturn(Mono.error(notFoundError));
